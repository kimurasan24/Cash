...
import PayPay from '../assets/PayPay.jpeg';
import Dpay from '../assets/Dpay.png';
import RakutenPay from '../assets/RakutenPay.jpeg';
import QRlogo from '../assets/QRlogo.png';
import { Image, Flex, Button, Grid, Box, Text, VStack } from '@chakra-ui/react';

const QRcodeIndex: React.FC<{ fetchNewsByKeyword: (keyword: string) => void }> = ({ fetchNewsByKeyword }) => {
  const buttonItems = [
    { keyword: "PayPay", image: PayPay },
    { keyword: "d払い", image: Dpay },
    { keyword: "楽天ペイ", image: RakutenPay },
    { keyword: "QR キャンペーン", image: QRlogo }
  ];
  return(
    <>
    <Box
      ...
      >
    <Text fontSize="md" fontWeight="bold">QRコード検索メニュー</Text>
  </Box>

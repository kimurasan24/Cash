...
const MileIndex: React.FC<{ fetchNewsByKeyword: (keyword: string) => void }> = ({ fetchNewsByKeyword }) => {
  const buttonItems = [
  ...
  return(
    ...
    <Box
      ...
      >
    <Text fontSize="md" fontWeight="bold">マイル検索メニュー</Text>
  </Box>
